...
export interface IKitShipmentStatusRepository {
    create(data: CreateKitShipmentStatusDto, userId: string): Promise<KitShipmentStatusDocument>
...
export const IKitShipmentStatusRepository = Symbol('IKitShipmentStatusRepository')
