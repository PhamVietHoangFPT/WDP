...
export type TestResultShipmentHistoryDocument =
  HydratedDocument<TestResultShipmentHistory>
...
export const TestResultShipmentHistorySchema = SchemaFactory.createForClass(
