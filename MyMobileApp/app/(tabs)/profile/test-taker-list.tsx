...
import {
  deleteTestTaker,
  getTestTakers,
} from "@/service/customerApi/testTaker-api";
      ...
      <LinearGradient colors={["#001f3f", "#0074D9"]} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          {testTakers.length > 0 ? (
            testTakers.map((taker) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({
                    pathname: "/profile/test-taker-detail",
                    params: { takerId: taker._id },
                  })
                }
              >
                ...
                <View style={styles.actions}>
                  <TouchableOpacity
                    onPress={() =>
                      router.push({
                        pathname: "/profile/edit-test-taker",
                        params: { takerId: taker._id },
                      })
                    }
                  >
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/profile/add-test-taker")}
          >
