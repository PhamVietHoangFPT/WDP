...
import { getAllServices } from "../../../services/service/serviceApi";
...
export default function AtHomeRegistration() {
  ...
  const handleRegister = (id: string) => {
    navigation.navigate("RegisterServiceAtHome", { serviceId: id });
  };
