...
const ManagerKitShipmentPage: React.FC = () => {
    ...
    const [selectedDeliveryStaff, setSelectedDeliveryStaff] = useState<DeliveryStaff | null>(null)
    ...
    const {
        data: kitShipmentsData,
        isLoading: isLoadingKitShipments,
    ...
    const handleAssignDeliveryStaff = (kitShipment: KitShipment, deliveryStaff: DeliveryStaff) => {
            ...
            items: deliveryStaffList.map((staff: DeliveryStaff) => ({
                ...
                label: (
                    ...
                    >
                        ...
                        <div style={{ fontSize: '12px', color: '#666' }}>{staff.phoneNumber}</div>
                    </div>
                ),
            })),
        }
                ...
                <div style={{ padding: '16px 0' }}>
                    <div style={{ marginBottom: '16px' }}>
                        ...
                        <div style={{ marginLeft: '16px', marginTop: '8px' }}>
                            ...
                            <div>• Số điện thoại: {selectedKitShipment?.account.phoneNumber}</div>
                            <div>
                                • Ngày đặt:{' '}
                    ...
                    >
                        ...
                        <div style={{ color: '#d46b08', marginTop: '4px' }}>
                            ...
                            nhân viên giao hàng phụ trách" và không thể hoàn tác.
                        </div>
                    </div>
                </div>
            </Modal>
