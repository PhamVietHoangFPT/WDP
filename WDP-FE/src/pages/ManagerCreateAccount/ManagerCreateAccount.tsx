      ...
      <Card style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        >
          ...
          <Form.Item label="Số điện thoại" name="phoneNumber" rules={[{ validator: validatePhoneNumber }]}>
            <Input placeholder="Nhập số điện thoại (VD: 0909090909)" size="large" />
          </Form.Item>

          <Form.Item label="Vai trò" name="role" rules={[{ required: true, message: "Vui lòng chọn vai trò!" }]}>
            <Select placeholder="Chọn vai trò" size="large" loading={isLoadingRoles} disabled={isLoadingRoles}>
