...
import { Form, InputNumber, DatePicker, Button, Typography, message } from 'antd';
...
const CreateSlot: React.FC = () => {
  ...
  const handleSave = async (values: { daysToGenerate: number; startDate: Dayjs }) => {
  ...
  try {
    ...
    const response = (await createSlots(formData).unwrap()) as { message: string }
