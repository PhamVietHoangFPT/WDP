...
const ReturnFail: React.FC = () => {
    ...
    if (
      ...
      if (defaultFailStatus) {
        ...
        setSearchParams((params) => {
          params.set('statusId', defaultFailStatus._id);
          return params;
        });
      } else if (statusListData.length > 0) {
        setSelectedStatus(statusListData[0]._id);
        setSearchParams((params) => {
          params.set('statusId', statusListData[0]._id);
          return params;
        });
      }
    }
  }, [statusListData, isStatusListSuccess, selectedStatus, setSearchParams]);
  ...
  useEffect(() => {
    ...
    if (currentEmail) setCustomerEmail(currentEmail);
