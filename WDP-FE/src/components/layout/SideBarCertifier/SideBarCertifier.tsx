...
export const SideBar = () => {
  ...
  const getSelectedKeys = () => {
    ...
    if (pathname === '/certifier') return ['certifier']
  ...
  const items = [
    {
      key: 'certifier', // Đảm bảo key khớp với path
      icon: <BarChartOutlined />, // Có thể thay bằng icon khác phù hợp hơn nếu có
      label: 'Trang chủ',
      onClick: () => navigate('certifier'),
    },
    {
      key: '/certifier/service-cases-without-adn-documentation-false', // Đảm bảo key khớp với path
      icon: <MenuUnfoldOutlined />, // Có thể thay bằng icon khác phù hợp hơn nếu có
      label: 'Hồ sơ đợi duyệt kết quả',
      onClick: () =>
        navigate('/certifier/service-cases-without-adn-documentation-false'),
    },
    {
      key: '/certifier/service-cases-without-adn-documentation-true', // Đảm bảo key khớp với path
      icon: <MenuUnfoldOutlined />, // Có thể thay bằng icon khác phù hợp hơn nếu có
      label: 'Hồ sơ đã duyệt kết quả',
      onClick: () =>
        navigate('/certifier/service-cases-without-adn-documentation-true'),
    },
  ]
