...
import {
    ...
    MedicineBoxOutlined,
    BarChartOutlined,
    // Thêm các icon khác cho các mục menu mới nếu cần
    // Ví dụ:
    // SnippetsOutlined, // cho Quản trị mẫu thu
    // FileProtectOutlined, // cho Quản trị dịch vụ
    // UserAddOutlined, // cho Quản trị tài khoản
